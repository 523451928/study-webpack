...
//					$(this).fadeOut(150, function() {
				...
				$(document).on("focus", "input", function() {
					var $formError = $(this).siblings('.formError');
					if($formError.hasClass('formError')){
						$formError.click();
					}
				});
			}
...
//					first_err.focus();
		...
		*/
		_maxSize: function(field, rules, i, options) {
			...
			{len +=  val.charCodeAt(i) >= 0x4e00 ? 2:1 }
			if (len > max) {
		...
		_buildPrompt: function(field, promptText, type, ajaxed, options) {
			...
			if(positionType === 'centerRight'){
				prompt.css({
					...
					"top": options.Top||pos.callerTopPosition,
					"right": -20,
		...
		*/
		_updatePrompt: function(field, prompt, promptText, type, ajaxed, options, noAnimation) {
			...
			if (prompt) {
				...
				var pos = methods._calculatePosition(field, prompt, options);
				var css = {"top": options.Top||pos.callerTopPosition,
//				"left": pos.callerleftPosition,
				"marginTop": pos.marginTopSize};
