...
Lazyload.install = function(Vue, options) {
  let opt = {
    ...
    loadImg: require('../../assets/images/lightbox/loading.gif'),
    threshold: 100,
    opa: 0.3,
    duration: 1000
  }
  ...
  Vue.directive('lazyload', {
    ...
    inserted(el, binding) {
      ...
      function scrollUp() {
        ...
        if (el.getBoundingClientRect().top < window.innerHeight + opt.threshold && el.getBoundingClientRect().left < window.innerWidth + opt.threshold) {
