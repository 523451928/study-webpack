              ...
              <div id="normal-inv" class="tab-pane fade in">
                <div class="form form-base">
                  <div class="form-group">
                    <label>发票主体:</label>
                    <div class="form-cont">
                      <a href="javascript:void(0)" class="btn btn-default inv-body" v-for="(item,index) in invoiceType" :class="{active: item.isActive}" @click="tab(item,index)">
                        <span>{{item.name}}</span>
                        <i class="ww-icon small-ok" :class="{activeOk: item.isActive}"></i>
                      </a>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-cont">
                      ...
                      <a href="" target="_blank" class="">发票信息相关问题>></a>
                    </div>
                  </div>
                </div>
              </div>
...
//          console.log(this.curInvoiceIndex)
    ...
    computed: {
      isDeatilInv() {
        return this.invoiceType[0].isActive
      }
    }
  }
</script>
