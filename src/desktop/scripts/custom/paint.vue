...
<div class="paint" :style="box">
  ...
  <div v-else :style="div"><img v-if="src" :src="src" :style="img"></div>
</div>
</template>

<script>
import { loadImage } from 'utils/image'
import { getThumbnailLength, addUnit, rejectImage, parseSize } from './util'
...
export default {
  ...
  computed: {
    ...
    src() {
      let d = this.dst
      if (d) {
        return this.$request.thumbnail('image', d.p.Image.Id,
