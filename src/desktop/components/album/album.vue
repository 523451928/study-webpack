        ...
        <div class="modal-content" v-drag>
          <div class="modal-body clearfix">
            <div class="ww-add-album clearfix">
              <h2 class="ww-add-album-title">{{editHideOne?'新建作品集':'编辑作品集'}}
                ...
                <li class="clearfix">
                  ...
                  <div class="input-group ww-album-group">
                    <template v-if="editHideOne">
                      <input type="text" id="album-edit-title" v-model="albumTitle" @keyup.enter="newAlbum" class="form-control ww-album-edit-area album-title" placeholder="请填写图片名称"/>
                    ...
                    <template v-if="editHideTwo">
                      <input type="text" id="album-edit-title" v-model="editTitle" @keyup.enter="editAlbum" class="form-control ww-album-edit-area album-title" placeholder="请填写图片名称"/>
  ...
  export default {
    data() {
      return {
        ...
        obj: [],
        styleObj: {},
        m2bgImg: require('assets/images/custom/m2bg.jpg')
      }
    },
    mounted() {
      this.pull()
      console.log('m2bg:', this.m2bgImg)
    },
    methods: {
      pull() {
        let self = this
      ...
      backImg() {
        ...
        _.each(this.obj, function(v) {
          ...
          let str = ''
          if (cId) {
            str = `url(${Interf.baseUrl}/thumbnail/image/${v['CoverId']}/480/${v['CoverFile']}) no-repeat center`
          } else {
            str = `url(${self.m2bgImg}) no-repeat center`
          }
