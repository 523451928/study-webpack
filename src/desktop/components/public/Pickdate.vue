<template>
  <div id="pick-date" :style="pickStyle" @click.stop="">
    <div class="pick-tools">
      <div class="pick-top">
          <span class="prev-year" v-show="isChangeYear"  :class="{'disPrev':disPrevYear}" @click.stop="prevYear">«</span>
          <span class="pick-prev" @click.stop="prevMonth" :class="{'disPrev':disPrev}" :style="arrowLeft">
        ...
        <input type="text" v-model="year"  @change="changeYear" min="1970" max="2100" maxlength="4">
        /
        {{monthString}}
        <span class="pick-next" @click.stop="nextMonth" :class="{'disNext':disNext}" :style="arrowRight">
                      <svg width="16" height="16" viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg"
                           xmlns:xlink="http://www.w3.org/1999/xlink"><g class="transform-group"><g
                        transform="scale(0.015625, 0.015625)"><path
        ...
        <span class="next-year" v-show="isChangeYear" :class="{'disNext':disNextYear}" @click.stop="nextYear">»</span>
      </div>
    </div>
