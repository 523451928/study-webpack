        ...
        <div class="item form-item master-cont-wrap">
          ...
          <form id="master-form" class="form form-base user-form">
            ...
            <div class="form-group">
              ...
              <div class="form-cont">
                <select class="form-control w110" id="identity-district" v-model="country" @change="selectCountry">
                  <option v-for="item in Country">{{item[0]}}</option>
                </select>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <label for="rule-allow-checkbox" class="checkbox-inline text-left copyright-label" id="rule-allow-area">
                  ...
                  <a href="../static/copy-right.html"> 《杭州墙蛙科技有限公司版权承诺协议》</a>
              </label>
            </div>
  ...
  export default {
    ...
    methods: {
      ...
      success(data) {
        ...
        this.IdEmblem = data.IdEmblem
        this.IdInHand = data.IdInHand
        this.imgSrc1 = request.thumb('identify', this.id, 480, this.IdAvatar)
        this.imgSrc2 = request.thumb('identify', this.id, 480, this.IdEmblem)
        this.imgSrc3 = request.thumb('identify', this.id, 480, this.IdInHand)
      },
      city() {
        let self = this
