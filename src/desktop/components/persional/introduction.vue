  ...
  <div class="row user-des">
    <div class="col-md-6">
      ...
      <div class="persional-coupon">
        <h2 class="user-des-title"><span class="per-avatar-name" v-text="obj.Nickname"></span>的优惠码</h2> 下单时输入优惠码 <span class="per-coupon-code" v-text="obj.CouponUser.Code"></span> 可优惠¥{{obj.CouponUser.Amount/100}}元。 相应地，<span class="per-avatar-name" v-text="obj.Nickname"></span>也将获得10元返现红包。
      </div>
    </div>
